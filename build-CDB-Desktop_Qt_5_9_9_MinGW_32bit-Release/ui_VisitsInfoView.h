...
public:
    ...
    void setupUi(QDialog *VisitsInfoView)
    {
        ...
        sizePolicy.setHeightForWidth(VisitsInfoView->sizePolicy().hasHeightForWidth());
        VisitsInfoView->setSizePolicy(sizePolicy);
        VisitsInfoView->setMinimumSize(QSize(418, 220));
        VisitsInfoView->setMaximumSize(QSize(418, 16777215));
