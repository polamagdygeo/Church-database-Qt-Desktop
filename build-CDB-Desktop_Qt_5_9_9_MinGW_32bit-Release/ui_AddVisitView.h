...
public:
    ...
    void setupUi(QDialog *AddVisit)
    {
        ...
        sizePolicy.setHeightForWidth(AddVisit->sizePolicy().hasHeightForWidth());
        AddVisit->setSizePolicy(sizePolicy);
        AddVisit->setMinimumSize(QSize(380, 111));
        AddVisit->setMaximumSize(QSize(380, 111));
