...
public:
    ...
    void setupUi(QDialog *AddPerson)
    {
        ...
        widget->setGeometry(QRect(10, 10, 476, 225));
        ...
        lineEdit_personName = new QLineEdit(widget);
        ...
        lineEdit_personName_2 = new QLineEdit(widget);
        ...
        lineEdit_birthPlace = new QLineEdit(widget);
        ...
        dateEdit_birthDate->setWrapping(false);
        ...
        lineEdit_natId = new QLineEdit(widget);
        ...
        lineEdit_jobTitle = new QLineEdit(widget);
        ...
        lineEdit_education = new QLineEdit(widget);
        ...
        lineEdit_mobId = new QLineEdit(widget);
