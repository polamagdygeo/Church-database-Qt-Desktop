...
public:
    ...
    void setupUi(QDialog *EditPersonView)
    {
        ...
        widget = new QWidget(EditPersonView);
        widget->setObjectName(QStringLiteral("widget"));
        widget->setGeometry(QRect(11, 12, 476, 223));
        ...
        lineEdit_personGender = new QLineEdit(widget);
        ...
        lineEdit_personName_3 = new QLineEdit(widget);
        ...
        lineEdit_natId_3 = new QLineEdit(widget);
        ...
        dateEdit_birthDate_3 = new QDateEdit(widget);
        ...
        dateEdit_birthDate_3->setWrapping(false);
        ...
        dateEdit_birthDate_3->setCalendarPopup(true);
        ...
        lineEdit_birthPlace_3 = new QLineEdit(widget);
        ...
        lineEdit_company_3 = new QLineEdit(widget);
        ...
        lineEdit_jobTitle_3 = new QLineEdit(widget);
        ...
        lineEdit_education_3 = new QLineEdit(widget);
        ...
        lineEdit_mobId_3 = new QLineEdit(widget);
        ...
        pushButton_mainWinReturn_3 = new QPushButton(widget);
        ...
        pushButton_editPerson = new QPushButton(widget);
